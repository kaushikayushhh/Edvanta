      ...
      <div className="section-container">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-xl font-medium ml-1">Edvanta</span>
            </motion.div>
            <motion.p 
            ...
            >
              <motion.a 
                ...
                href="#" 
                className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-900 hover:bg-blue-600 hover:text-white transition-colors"
              >
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} Edvanta.com
            </motion.p>
            <motion.p 
              variants={fadeIn('left', 1.0)}
              className="text-gray-600 text-sm"
            >
              Created by Edvanta & Team Head Ayush kaushik
            </motion.p>
          </motion.div>
        </motion.div>
      </div>
