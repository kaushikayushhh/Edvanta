      ...
      <div className="w-full md:w-1/2 space-y-8">
        ...
        >
          ...
          <div className="flex items-center gap-2 bg-gray-100  w-fit px-4 py-2 rounded-full hover:bg-gray-100 transition-colors cursor-pointer group">
            ...
            <span className="text-sm font-medium">One-stop hub for Business needs</span>
          </div>
        </motion.div>
        ...
        >
          Empowering Businesses Solutions{' '}
          <span className="text-red-700 relative inline-block">
        ...
        >
          ...
          />
          <button className="bg-red-600 text-white px-8 py-4 rounded-xl hover:bg-red-700 cursor-pointer transition-all hover:shadow-lg hover:shadow-blue-100 active:scale-95">
            →
          </button>
        </motion.div>
      </div>
